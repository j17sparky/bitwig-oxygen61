...
host.defineController("M-Audio", "Oxygen 61", "1.0", "4B6AB540-B75A-11E3-A5E2-0800200C9A66");


host.defineMidiPorts(1, 1);

host.addDeviceNameBasedDiscoveryPair(["Oxygen 61"], ["Oxygen 61"]);

// Search after different naming-schemes for autodetection
for ( var i = 1; i < 9; i++)
{
	var name = i.toString() + "- Oxygen 61";
	host.addDeviceNameBasedDiscoveryPair([name], [name]);
	host.addDeviceNameBasedDiscoveryPair(["Oxygen 61 MIDI " + i.toString()], ["Oxygen 61 MIDI " + i.toString()]);
}
...
function init()
{
	...
	noteIn = host.getMidiInPort(0).createNoteInput("Oxygen 61 Keyboard");
